  ...
  return (
    <div className="flex flex-col items-center text-center group">
      ...
      <div className="relative mb-4">
        ...
        <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-r from-brand-500 to-brand-600 text-white text-xs font-bold flex items-center justify-center">
          {step}
        </span>
      </div>
